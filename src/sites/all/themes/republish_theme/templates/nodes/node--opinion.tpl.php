  ...
  <div class="content"<?php print $content_attributes; ?>>
    <div class="above-img">
      <div class="field-name-field-section">
        <div class="links">
          <div>
            <a href="/opinion">ניתוחים ודעות</a>
          </div>
        </div>
      </div>
      ...
      <hr>
      <a class="print" style="display:none;" href="/print/<?php print $node->nid;?>" target="_blank"><?php print t('Print');?></a>
      <?php print render($content['field_tags']); ?>
    </div>
    <?php print render($content['field_images']); ?>
    <div class="under-img">
      <?php print render($content['body']); ?>
      <?php print $about_the_writer; ?>
      <?php 
